...
public class WindowsClientLocators {
	...
	public By SEARCH_CONTACT_LOCAL_CONTACT_TITLE_BAR = By.xpath("//*[contains(@Name,'CONTACTS')]");
	...
	public By search_contact_enterprise_result() {
		return By.xpath("//*[contains(@Name,'ENTERPRISE')]//following-sibling::*[contains(@Name,'Search Results')]/*[contains(@Name,'Avaya.UCC.ViewModels.DashboardTabContents.Contacts.ContactViewModel')]");
	}
	public By search_contact_local_result (String name) {
		return By.xpath("//*[contains(@Name,'CONTACTS')]//following-sibling::*[contains(@Name,'Search Results')]/*[contains(@Name,'Avaya.UCC.ViewModels.DashboardTabContents.Contacts.ContactViewModel')]/*[contains(@Name,'"+name+"')]");
	}
	...
	public By CONTACT_TAB_SCREEN_ADD_CONTACT_BTN				=	By.xpath("//*[@AutomationId='AddContactButton']");
...
//	public By ADD_CONTACT_SCREEN_AMM_ADDRESS_TXT				=	By.xpath("//*[@AutomationId = 'PART_TextBoxEx'][2]");
	...
	public By CONTACT_LIST_CONTACT_DETAIL_DISMISS_BTN = By.name("DISMISS");
	public By CONTACT_LIST_CONTACT_DETAIL_OK_BTN = By.name("DISMISS");
	
	public By CONTACT_IN_CONTACT_LIST(String user) {
		return By.xpath("//*[@AutomationId='ContactsListBox']//*[@Name='"+user+"']");
	}
	public By INCOMING_CALL_NOTIFICATION_ACCEPT_BTN				=	By.name("Answer");
	public By INCOMING_CALL_NOTIFICATION_REJECT_BTN				=	By.name("Deny");
	public By INCOMING_CALL_DROP_BTN				            =	By.name("Drop");
	public By INCOMING_CALL_NOTIFICATION_ACCEPT_VIDEO_BTN		=	By.id("CallStackAcceptVideoButton");
...
//	public By CONTACT_BUBBLE_CONTINUE_EXISTING_CONVERSATION(String convName) 	{ return 	By.xpath("//*[@Name='" + convName + "']");}
	...
	public By SETTING_WINDOWS_LDAP_SERVER = By.xpath("//*[@AutomationId='LdapServerAddressAutomationIdTextSettingTextBox']");
	public By SETTING_WINDOWS_LDAP_PORT = By.xpath("//*[@AutomationId='LdapPortAutomationIdNumericSettingTextBox']");
...
//	public By CONTACT_LIST_CANCLE_SEARCH_BTN = By.xpath("//*[@Name='Cancel']");
	...
	public By ElementByName(String name) {
		return By.name(name);
	}
	...
	public By SETTING_WINDOWS_BACK_BTN													=	By.xpath("//*[@Name = 'Back']/..");
	...
	public By MAIN_WINDOWS_TOP_OF_MIND_BTN							=	By.xpath("//*[@AutomationId='TabBarHomeContentToggleButton']");
//	public By MAIN_WINDOWS_TOP_OF_MIND_BTN							=	By.xpath("TabBarHomeContentToggleButton");
	...
	public By MAIN_WINDOWS_HISTORY_BTN								=	By.xpath("//*[@AutomationId='TabBarCallHistoryContentToggleButton']");
	...
	public By MAIN_WINDOWS_AVATAR_BTN								=	By.xpath("//*[@AutomationId='UserDashboardOpenAvatarButton']");
	public By MAIN_WINDOWS_CLOSE_AVATAR_BTN								=	By.id("PresencePopupCloseAvatarButton");
	public By MAIN_WINDOWS_SIGN_OUT_TEXT							= 	By.xpath("//*[@AutomationId='PresencePopupLogOutTextBlock']");
	...
	public By MAIN_WINDONS_CONTACT_TAB_START_CONVERSATION_BTN(String username) {
		
		return By.xpath("//*[@AutomationId='ContactCallButton("+ username +")']");//*[@Name='"+status+"']/..
	} 
...
//	public By equinoxInTaskbar = By.xpath("//*[@Name = 'Avaya Equinox' and @LocalizedControlType = 'menu item']");
    ...
    //public By ACW_CALL_TXT_SEARCH_NAME_OR_NUMBER = By.name("Search for someone (F3) or enter a number to call");
    public By ACW_CALL_TXT_SEARCH_NAME_OR_NUMBER = By.xpath("//*[@ClassName='TextBox']");
    public By ACW_CALLEE_INFO(String name) {
        return By.name(name);
    }
    public By ACW_CALL_BTN_MAKE_VOICE_CALL = By.id("PART_MakeAVoiceCallButton");
    public By ACW_CALL_BTN_DROP_CALL = By.name("Drop");
    public By ACW_CALL_BTN_ANSWER_CALL = By.name("Answer");
    public By ACW_CALL_BTN_HOLD_CALL = By.name("Pause");
    public By ACW_CALL_BTN_RESUME_CALL = By.name("Pause");
    public By ACW_CALLER_INFO = By.xpath("//*[AutomationId = 'CallStackListBoxItem1']/../*[contains(@AutomationId, 'CaIncomingDisplayName')]");
	...
	public By mainWindowsContactsTabUserActionLocators(String action, String user){	
		return By.xpath("//*[contains(@Name,'Contact list')]//*[contains(@Name,'"+user+"')]//*[contains(@Name,'"+action+"')]");
	}
	...
	//###########################################################################################################################
	//############################################## OUTGOING CALL LOCATORS #########################################################
	//###########################################################################################################################

public By OUTGOMING_CALL_BOX				=	By.id("CallStackListBoxItem4");
public By OUTGOING_CALL_DROP_BTN		    =	By.name("Drop");

//###########################################################################################################################
	//############################################## ENHANCED SEARCH CONTACT #########################################################
	//###########################################################################################################################
public By ENHANCED_SEARCH_DROP_BTN		    =	By.xpath("//*[@AutomationId='PART_OpenEnhancedSearchButton']");	
public By ENHANCED_SEARCH_NAME_TXT			= 	By.xpath("//*[@AutomationId='PART_OpenEnhancedSearchButton']/..");
public By ENHANCED_SEARCH_LOCATION_TXT		= 	By.xpath("//*[@ClassName='TextBox'][2]");
public By ENHANCED_SEARCH_DEPARTMENT_TXT	= 	By.xpath("//*[@ClassName='TextBox'][3]");
public By ENHANCED_SEARCH_BTN 				= 	By.xpath("//*[@AutomationId='EnhancedSearchButton']");
