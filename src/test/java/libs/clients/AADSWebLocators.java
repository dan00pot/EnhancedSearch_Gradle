...
public class AADSWebLocators {
	...
	public By STATUS_AFTER_PUBLISH = By.xpath("//*[@id='statusmessage']");

	public By DYNAMIC_CONFIGURATION_CONFIGURATION_PAGE_SAVE_USER_COMFIRM_BTN = By
			.xpath("//button[@title='Save a configuration in database before publish']");
	...
	// ###########################################################################################################################
		// ########################################LOCATOR OF WEB ELEMENTS IN ENHANCE SEARCH#################################
	public By ENHANCE_SEARCH_OPTION = By.xpath("//*[@id='gwt-debug-attributeCondition']");
	public By ENHANCE_SEARCH_OPTION_START_WITH = By.xpath("//*[@id='gwt-debug-attributeCondition-item0']");
	public By ENHANCE_SEARCH_OPTION_CONTAINS = By.xpath("//*[@id='gwt-debug-attributeCondition-item1']");
	public By ENHANCE_SEARCH_SAVE_BTN = By.xpath("//*[@id='gwt-debug-submitButton']");
}
